    ...
    def generate(
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            constraints: TODO: to be written
        ...
        is_constraint_beam_gen_mode = (num_beams > 1) and (num_beam_groups == 1) and do_sample is False and constraints is not None
        ...
        elif is_constraint_beam_gen_mode:
    ...
    def constrained_beam_search(self,
        ...
        **model_kwargs,
        ...
        if len(stopping_criteria) == 0:
            warnings.warn("You haven't defined any stopping_criteria, this will likely loop forever", UserWarning)
        pad_token_id = pad_token_id if pad_token_id is not None else self.config.pad_token_id
        eos_token_id = eos_token_id if eos_token_id is not None else self.config.eos_token_id
        output_scores = output_scores if output_scores is not None else self.config.output_scores
        output_attentions = output_attentions if output_attentions is not None else self.config.output_attentions
        ...
        beam_scorer.init_constraints(constraints, num_beams)
        this_peer_finished = False  # used by synced_gpus only
        while True:
